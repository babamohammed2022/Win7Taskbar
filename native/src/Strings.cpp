...
/* ------------------------------------------------------------------------ */
/*  Flyout di rete variante Windows 8 (v3.8; implementazione: Administratox) */
/* ------------------------------------------------------------------------ */
constexpr W8NetStrings kW8NetIt = {
        L"Reti",
        L"Connetti",
        L"Disconnetti",
        ...
        L"Protetta",
        L"Aperta",
        L"Impossibile connettersi a questa rete",
        L"Nessuna rete disponibile",
        L"Reti non disponibili"
};
constexpr W8NetStrings kW8NetEn = {
        L"Networks",
        L"Connect",
        L"Disconnect",
        L"Connecting...",
        ...
        L"Secured",
        L"Open",
        L"Can't connect to this network",
        L"No networks are available",
        L"Networks aren't available"
};
constexpr W8NetStrings kW8NetEs = {
        L"Redes",
        L"Conectar",
        L"Desconectar",
        L"Conectando...",
        ...
        L"Protegida",
        L"Abierta",
        L"No se puede conectar a esta red",
        L"No hay redes disponibles",
        L"Las redes no están disponibles"
};
constexpr W8NetStrings kW8NetFr = {
        L"Réseaux",
        L"Se connecter",
        L"Se déconnecter",
        ...
        L"Sécurisé",
        L"Ouvert",
        L"Impossible de se connecter à ce réseau",
        L"Aucun réseau disponible",
        L"Les réseaux ne sont pas disponibles"
};
constexpr W8NetStrings kW8NetDe = {
        L"Netzwerke",
        L"Verbinden",
        L"Trennen",
        L"Verbindung wird hergestellt...",
        L"Verbindung wird getrennt...",
        L"Verbunden",
        L"Gesichert",
        L"Offen",
        L"Es kann keine Verbindung mit diesem Netzwerk hergestellt werden",
        L"Keine Netzwerke verfügbar",
        L"Netzwerke sind nicht verfügbar"
};
constexpr W8NetStrings kW8NetPt = {
        L"Redes",
        L"Ligar",
        L"Desligar",
        L"A ligar...",
        ...
        L"Protegida",
        L"Aberta",
        L"Não é possível ligar a esta rede",
        L"Não existem redes disponíveis",
        L"As redes não estão disponíveis"
};
constexpr W8NetStrings kW8NetPl = {
        L"Sieci",
        L"Połącz",
        L"Rozłącz",
        L"Łączenie...",
        ...
        L"Zabezpieczona",
        L"Otwarta",
        L"Nie można połączyć z tą siecią",
        L"Brak dostępnych sieci",
        L"Sieci są niedostępne"
};
constexpr W8NetStrings kW8NetRu = {
        L"Сети",
        L"Подключить",
        L"Отключить",
        L"Подключение...",
        ...
        L"Защищена",
        L"Открытая",
        L"Не удаётся подключиться к этой сети",
        L"Нет доступных сетей",
        L"Сети недоступны"
};
constexpr W8NetStrings kW8NetJa = {
        L"ネットワーク",
        L"接続",
        L"切断",
        L"接続しています...",
...
constexpr W8NetStrings kW8NetZh = {
        L"网络",
        L"连接",
        L"断开连接",
        L"正在连接...",
...
constexpr W8NetStrings kW8NetAr = {
        L"الشبكات",
        L"اتصال",
        L"قطع الاتصال",
        L"جارٍ الاتصال...",
        ...
        L"محمية",
        L"مفتوحة",
        L"تعذر الاتصال بهذه الشبكة",
        L"لا توجد شبكات متوفرة",
        L"الشبكات غير متوفرة"
};

const W8NetStrings& PickW8Net(Lang lang) {
    switch (lang) {
        case Lang::It: return kW8NetIt;
        case Lang::Es: return kW8NetEs;
        case Lang::Fr: return kW8NetFr;
        case Lang::De: return kW8NetDe;
        case Lang::Pt: return kW8NetPt;
        case Lang::Pl: return kW8NetPl;
        case Lang::Ru: return kW8NetRu;
        case Lang::Ja: return kW8NetJa;
        case Lang::Zh: return kW8NetZh;
        case Lang::Ar: return kW8NetAr;
        default:       return kW8NetEn;
    }
}
