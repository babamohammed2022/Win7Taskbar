...
bool ReadToolbar(HWND toolbar, bool fromOverflow,
    ...
    for (int i = 0; i < count; i++) {
        ...
        /* IsPromoted e' la configurazione effettiva di Windows 11: 1 =
         * icona nella zona visibile, 0 = icona nel cassetto overflow. La
         * chiave privata usa un nome decimale opaco; il lettore ha gia'
         * verificato UID + ExecutablePath prima di adottare il valore. In
         * assenza di una corrispondenza, la toolbar resta il fallback reale
         * (non una euristica basata sul nome del processo). */
